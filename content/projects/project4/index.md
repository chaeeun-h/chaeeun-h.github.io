...
date: 2023-10-10
tags: ["computer vision","security and privacy","active learning"]
author: ["Prof. Aron Laszka"]
description: "This project presents how to detect image data correctly with small training dataset to defense machine learning models from poisoning attacks." 
summary: "This project presents how to detect image data correctly with small training dataset to defense machine learning models from poisoning attacks." 
cover:
    image: "project4.png"
    alt: "Figure caption"
    relative: false
