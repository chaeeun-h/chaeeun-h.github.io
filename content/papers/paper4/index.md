...
date: 2024-01-09
tags: ["Public Transportation","Data-Driven Optimization","Disruption Forecasting","Simulation", "Metaheuristic Optimization"]
author: ["Chaeeun Han", "Jose Paolo Talusan", "Dan Freudberg", "Ayan Mukhopadhyay", "Abhishek Dubey", "Aron Laszka"]
description: "This paper shows the disruptions forecasting model and bus-dispatch simulation according to them. Published in Conference AAMAS 2024 (Acceptance rate: 25%)" 
summary: "In this study, we propose a disruption forecasting system that assists bus dispatch simulation model." 
# cover:
#     image: "paper4.png"
#     alt: "Image caption"
#     relative: false
