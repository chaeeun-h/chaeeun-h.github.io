...
+ Webpages are organized in three categories, which are available from any page through the menu and from the homepage through buttons: papers, projects, and data.
+ A list of tags (keywords) used in papers and projects is automatically generated so visitors can easily see the topics covered in research and teaching.
...
+ The template provides new archetypes for paper pages, project pages, and a search page.
